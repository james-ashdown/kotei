...
impl U64F<-66> {
    ...
    pub const FRAC_1_TAU: Self = Self {
        significand: 0xA2F9836E4E44152A,
    };
}
...
impl U64F<-65> {
    ...
    pub const FRAC_PI_8: Self = Self {
        significand: 0xC90FDAA22168C235,
    };
    /// log<sub>10</sub>(2)
    pub const LOG10_2: Self = Self {
        significand: 0x9A209A84FBCFF799,
    };
    /// log<sub>10</sub>(e)
    pub const LOG10_E: Self = Self {
        significand: 0xDE5BD8A937287195,
    };
}
...
impl U64F<-64> {
    ...
    pub const EULER_GAMMA: Self = Self {
        significand: 0x93C467E37DB0C7A5,
    };
    /// 1/sqrt(2)
    pub const FRAC_1_SQRT_2: Self = Self {
        significand: 0xB504F333F9DE6484,
    };
    /// 2/π
    ...
    pub const FRAC_PI_6: Self = Self {
        significand: 0x860A91C16B9B2C23,
    };
    /// ln(2)
    pub const LN_2: Self = Self {
        significand: 0xB17217F7D1CF79AC,
    };
}
...
impl U64F<-63> {
    ...
    pub const FRAC_2_SQRT_PI: Self = Self {
        significand: 0x906EBA8214DB688D,
    };
    /// π/2
    ...
    pub const GOLDEN_RATIO: Self = Self {
        significand: 0xCF1BBCDCBFA53E0B,
    };
    /// log<sub>2</sub>(e)
    pub const LOG2_E: Self = Self {
        significand: 0xB8AA3B295C17F0BC,
    };
    /// sqrt(2)
...
impl U64F<-62> {
    ...
    pub const E: Self = Self {
        significand: 0xADF85458A2BB4A9B,
    };
    /// ln(10)
    pub const LN_10: Self = Self {
        significand: 0x935D8DDDAAA8AC17,
    };
    /// log<sub>2</sub>(10)
    pub const LOG2_10: Self = Self {
        significand: 0xD49A784BCD1B8AFE,
    };
...
impl<const E: i32> U64F<E> {
    ...
    pub const fn from_i8f(value: I8F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand < u64::MIN as i8 {
            crate::panic::from();
        }

        let significand = value.significand as u64;
    ...
    pub const fn strict_from_i8f(value: I8F<E>) -> Self {
        if value.significand < u64::MIN as i8 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_i8f(value: I8F<E>) -> (Self, bool) {
        let overflowed = value.significand < u64::MIN as i8;
        let significand = value.significand as u64;
    ...
    pub const fn from_i16f(value: I16F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand < u64::MIN as i16 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i16f(value: I16F<E>) -> Self {
        if value.significand < u64::MIN as i16 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_i16f(value: I16F<E>) -> (Self, bool) {
        let overflowed = value.significand < u64::MIN as i16;
        let significand = value.significand as u64;
    ...
    pub const fn from_i32f(value: I32F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand < u64::MIN as i32 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i32f(value: I32F<E>) -> Self {
        if value.significand < u64::MIN as i32 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_i32f(value: I32F<E>) -> (Self, bool) {
        let overflowed = value.significand < u64::MIN as i32;
        let significand = value.significand as u64;
    ...
    pub const fn from_i64f(value: I64F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand < u64::MIN as i64 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i64f(value: I64F<E>) -> Self {
        if value.significand < u64::MIN as i64 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_i64f(value: I64F<E>) -> (Self, bool) {
        let overflowed = value.significand < u64::MIN as i64;
        let significand = value.significand as u64;
    ...
    pub const fn from_i128f(value: I128F<E>) -> Self {
        if cfg!(debug_assertions)
            && (value.significand < u64::MIN as i128 || value.significand > u64::MAX as i128)
        {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i128f(value: I128F<E>) -> Self {
        if value.significand < u64::MIN as i128 || value.significand > u64::MAX as i128 {
            crate::panic::from();
        }
    ...
    pub const fn saturating_from_i128f(value: I128F<E>) -> Self {
        if value.significand < u64::MIN as i128 {
            return Self::MIN;
        } else if value.significand > u64::MAX as i128 {
            return Self::MAX;
        }
    ...
    pub const fn from_u128f(value: U128F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand > u64::MAX as u128 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_u128f(value: U128F<E>) -> Self {
        if value.significand > u64::MAX as u128 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_u128f(value: U128F<E>) -> (Self, bool) {
        let overflowed = value.significand > u64::MAX as u128;
        let significand = value.significand as u64;
    ...
    pub const fn from_ne_bytes(bytes: [u8; 8]) -> Self {
        Self {
            significand: u64::from_ne_bytes(bytes),
        }
    }
    ...
    pub const fn from_be_bytes(bytes: [u8; 8]) -> Self {
        Self {
            significand: u64::from_be_bytes(bytes),
        }
    }
    ...
    pub const fn from_le_bytes(bytes: [u8; 8]) -> Self {
        Self {
            significand: u64::from_le_bytes(bytes),
        }
    }
    ...
    #[must_use]
    #[track_caller]
    pub const fn rescale<const E2: i32>(self) -> U64F<E2> {
        ...
        if const { E > E2 } {
            ...
            if shift >= u64::BITS {
                ...
                let threshold = const { 1 << (u64::BITS - 1) };

                x = (x > threshold) as u64;
            } else {
                let mask = const {
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_rescale<const E2: i32>(self) -> U64F<E2> {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn wrapping_rescale<const E2: i32>(self) -> U64F<E2> {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn saturating_rescale<const E2: i32>(self) -> U64F<E2> {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn overflowing_rescale<const E2: i32>(self) -> (U64F<E2>, bool) {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn checked_rescale<const E2: i32>(self) -> Option<U64F<E2>> {
        let mut x = self.significand;
    ...
    pub const fn add_signed(self, rhs: I64F<E>) -> Self {
        let x = self.significand.wrapping_add(rhs.significand as u64);
    ...
    pub const fn wrapping_add_signed(self, rhs: I64F<E>) -> Self {
        Self {
            significand: self.significand.wrapping_add(rhs.significand as u64),
        }
    }
    ...
    pub const fn sub_signed(self, rhs: I64F<E>) -> Self {
        let x = self.significand.wrapping_sub(rhs.significand as u64);
    ...
    pub const fn wrapping_sub_signed(self, rhs: I64F<E>) -> Self {
        Self {
            significand: self.significand.wrapping_sub(rhs.significand as u64),
        }
    }
    ...
    #[must_use]
    #[track_caller]
    pub const fn mul<const R: i32>(self, rhs: U64F<R>) -> Self {
        let mut x = (self.significand as u128).wrapping_mul(rhs.significand as u128);
        ...
        if const { R > 0 } {
            ...
            if shift > u128::BITS {
                ...
                let threshold = const { 1 << (u128::BITS - 1) };

                x = (x > threshold) as u128;
            } else {
                let mask = const {
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_mul<const R: i32>(self, rhs: U64F<R>) -> Self {
        let mut x = (self.significand as u128).wrapping_mul(rhs.significand as u128);
    ...
    /// Computes `self * rhs`, wrapping around at the numeric bounds of the type.
    #[must_use]
    pub const fn wrapping_mul<const R: i32>(self, rhs: U64F<R>) -> Self {
        let mut x = (self.significand as u128).wrapping_mul(rhs.significand as u128);
    ...
    /// Computes `self * rhs`, saturating at the numeric bounds of the type instead of overflowing.
    #[must_use]
    pub const fn saturating_mul<const R: i32>(self, rhs: U64F<R>) -> Self {
        let mut x = (self.significand as u128).wrapping_mul(rhs.significand as u128);
    ...
    /// Computes `self * rhs`. Returns a tuple of the wrapping result and a boolean indicating whether overflow occurred.
    #[must_use]
    pub const fn overflowing_mul<const R: i32>(self, rhs: U64F<R>) -> (Self, bool) {
        let mut x = (self.significand as u128).wrapping_mul(rhs.significand as u128);
        let mut overflowed = false;
    ...
    /// Computes `self * rhs`, returning `None` if overflow occurred.
    #[must_use]
    pub const fn checked_mul<const R: i32>(self, rhs: U64F<R>) -> Option<Self> {
        let mut x = (self.significand as u128).wrapping_mul(rhs.significand as u128);
    ...
    #[must_use]
    #[track_caller]
    pub const fn mul_signed<const R: i32>(self, rhs: I64F<R>) -> Self {
        ...
        if cfg!(debug_assertions) && (x < u64::MIN as i128 || x > u64::MAX as i128) {
            crate::panic::mul();
        }
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_mul_signed<const R: i32>(self, rhs: I64F<R>) -> Self {
        let mut x = (self.significand as i128).wrapping_mul(rhs.significand as i128);
        ...
        if x < u64::MIN as i128 || x > u64::MAX as i128 {
            crate::panic::mul();
        }
    ...
    /// Computes `self * rhs`, wrapping around at the numeric bounds of the type.
    #[must_use]
    pub const fn wrapping_mul_signed<const R: i32>(self, rhs: I64F<R>) -> Self {
        let mut x = (self.significand as i128).wrapping_mul(rhs.significand as i128);
    ...
    /// Computes `self * rhs`, saturating at the numeric bounds of the type instead of overflowing.
    #[must_use]
    pub const fn saturating_mul_signed<const R: i32>(self, rhs: I64F<R>) -> Self {
        let mut x = (self.significand as i128).wrapping_mul(rhs.significand as i128);
    ...
    /// Computes `self * rhs`. Returns a tuple of the wrapping result and a boolean indicating whether overflow occurred.
    #[must_use]
    pub const fn overflowing_mul_signed<const R: i32>(self, rhs: I64F<R>) -> (Self, bool) {
        let mut x = (self.significand as i128).wrapping_mul(rhs.significand as i128);
        let mut overflowed = false;
        ...
        overflowed |= x < u64::MIN as i128 || x > u64::MAX as i128;
    ...
    /// Computes `self * rhs`, returning `None` if overflow occurred.
    #[must_use]
    pub const fn checked_mul_signed<const R: i32>(self, rhs: I64F<R>) -> Option<Self> {
        let mut x = (self.significand as i128).wrapping_mul(rhs.significand as i128);
    ...
    #[must_use]
    #[track_caller]
    pub const fn overflowing_div<const R: i32>(self, rhs: U64F<R>) -> (Self, bool) {
        const OFFSET: i32 = u64::BITS.cast_signed() - u128::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn overflowing_div_signed<const R: i32>(self, rhs: I64F<R>) -> (Self, bool) {
        const OFFSET: i32 = u64::BITS.cast_signed() - u128::BITS.cast_signed();
        ...
        overflowed |= (negative && x != 0) || x > u64::MAX as u128;
...
impl U64F<-63> {
    ...
    pub const fn cospi_2(self) -> I64F<-62> {
        let theta = self.significand as i64;
    ...
    pub const fn sinpi_2(self) -> I64F<-62> {
        ...
        let theta = (self.significand as i64).wrapping_add(PHASE_SHIFT);
        let significand = crate::algorithm::cospi_i64_2(theta);
...
impl<const E: i32, const R: i32> ops::Mul<U64F<R>> for U64F<E> {
    type Output = Self;
...
impl<const E: i32, const R: i32> ops::Mul<I64F<R>> for U64F<E> {
    type Output = Self;
...
impl<const E: i32, const R: i32> ops::Div<U64F<R>> for U64F<E> {
    type Output = Self;
...
impl<const E: i32, const R: i32> ops::Div<I64F<R>> for U64F<E> {
    type Output = Self;
...
impl<const E: i32> ops::AddAssign for U64F<E> {
    #[track_caller]
...
impl<const E: i32> ops::AddAssign<I64F<E>> for U64F<E> {
    #[track_caller]
    fn add_assign(&mut self, rhs: I64F<E>) {
        *self = Self::add_signed(*self, rhs)
    }
}

impl<const E: i32> ops::SubAssign for U64F<E> {
    #[track_caller]
...
impl<const E: i32> ops::SubAssign<I64F<E>> for U64F<E> {
    #[track_caller]
    fn sub_assign(&mut self, rhs: I64F<E>) {
        *self = Self::sub_signed(*self, rhs)
    }
}

impl<const E: i32, const R: i32> ops::MulAssign<U64F<R>> for U64F<E> {
    #[track_caller]
...
impl<const E: i32, const R: i32> ops::MulAssign<I64F<R>> for U64F<E> {
    #[track_caller]
...
impl<const E: i32, const R: i32> ops::DivAssign<U64F<R>> for U64F<E> {
    #[track_caller]
...
impl<const E: i32, const R: i32> ops::DivAssign<I64F<R>> for U64F<E> {
    #[track_caller]
