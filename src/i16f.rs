...
impl<const E: i32> I16F<E> {
    ...
    pub const fn mul<const R: i32>(self, rhs: I16F<R>) -> Self {
        ...
        if const { R > 0 } {
            ...
            if shift >= i32::BITS {
                ...
                let round = const {
                    let shift = R.wrapping_neg().wrapping_sub(1).cast_unsigned();

                    !(!0i32).unbounded_shl(shift)
                };
    ...
    pub const fn div<const R: i32>(self, rhs: I16F<R>) -> Self {
        ...
        let (x, overflowed) = ((self.0 as i32) << -OFFSET).overflowing_div(rhs.0 as i32);
        ...
        if const { R < OFFSET } {
            ...
            if shift >= u32::BITS {
                ...
                let round = const {
                    let shift = R.wrapping_sub(OFFSET).wrapping_sub(1).cast_unsigned();
    ...
    pub const fn div_unsigned<const R: i32>(self, rhs: U16F<R>) -> Self {
        ...
        let mut x = ((self.0 as i32) << -OFFSET) / rhs.0 as i32;
...
impl I16F<-15> {
    ...
    pub const fn cospi_2(self) -> I16F<-14> {
        I16F(crate::algorithm::cospi_i16_2(self.0))
    }
    ...
    pub const fn cospi_4(self) -> I16F<-14> {
        I16F(crate::algorithm::cospi_i16_4(self.0))
    }
    ...
    pub const fn cospi_6(self) -> I16F<-14> {
        I16F(crate::algorithm::cospi_i16_6(self.0))
    }
    ...
    pub const fn sinpi_2(self) -> I16F<-14> {
        I16F(crate::algorithm::cospi_i16_2(
            self.0.wrapping_add_unsigned(0xC000),
        ))
    }
