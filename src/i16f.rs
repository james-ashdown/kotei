...
impl<const E: i32> I16F<E> {
    ...
    pub const fn try_from_f32(value: f32) -> Result<Self, TryFromFloatError> {
        ...
        if significand < i16::MIN as i32 || significand > i16::MAX as i32 {
            return Err(TryFromFloatError::Overflow);
        }

        let significand = significand as i16;
    ...
    pub const fn try_from_f64(value: f64) -> Result<Self, TryFromFloatError> {
        ...
        if significand < i16::MIN as i64 || significand > i16::MAX as i64 {
            return Err(TryFromFloatError::Overflow);
        }
    ...
    pub const fn from_i32f(value: I32F<E>) -> Self {
        if cfg!(debug_assertions)
            && (value.significand < i16::MIN as i32 || value.significand > i16::MAX as i32)
        {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i32f(value: I32F<E>) -> Self {
        if value.significand < i16::MIN as i32 || value.significand > i16::MAX as i32 {
            crate::panic::from();
        }
    ...
    pub const fn saturating_from_i32f(value: I32F<E>) -> Self {
        if value.significand < i16::MIN as i32 {
            return Self::MIN;
        } else if value.significand > i16::MAX as i32 {
            return Self::MAX;
        }
    ...
    pub const fn from_i64f(value: I64F<E>) -> Self {
        if cfg!(debug_assertions)
            && (value.significand < i16::MIN as i64 || value.significand > i16::MAX as i64)
        {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i64f(value: I64F<E>) -> Self {
        if value.significand < i16::MIN as i64 || value.significand > i16::MAX as i64 {
            crate::panic::from();
        }
    ...
    pub const fn saturating_from_i64f(value: I64F<E>) -> Self {
        if value.significand < i16::MIN as i64 {
            return Self::MIN;
        } else if value.significand > i16::MAX as i64 {
            return Self::MAX;
        }
    ...
    pub const fn strict_from_i128f(value: I128F<E>) -> Self {
        if value.significand < i16::MIN as i128 || value.significand > i16::MAX as i128 {
            crate::panic::from();
        }
    ...
    pub const fn saturating_from_i128f(value: I128F<E>) -> Self {
        if value.significand < i16::MIN as i128 {
            return Self::MIN;
        } else if value.significand > i16::MAX as i128 {
            return Self::MAX;
        }
    ...
    pub const fn from_u16f(value: U16F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand > i16::MAX as u16 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_u16f(value: U16F<E>) -> Self {
        if value.significand > i16::MAX as u16 {
            crate::panic::from();
        }
    ...
    pub const fn from_u32f(value: U32F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand > i16::MAX as u32 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_u32f(value: U32F<E>) -> Self {
        if value.significand > i16::MAX as u32 {
            crate::panic::from();
        }
    ...
    pub const fn from_u64f(value: U64F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand > i16::MAX as u64 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_u64f(value: U64F<E>) -> Self {
        if value.significand > i16::MAX as u64 {
            crate::panic::from();
        }
    ...
    pub const fn from_u128f(value: U128F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand > i16::MAX as u128 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_u128f(value: U128F<E>) -> Self {
        if value.significand > i16::MAX as u128 {
            crate::panic::from();
        }
    ...
    pub const fn from_ne_bytes(bytes: [u8; 2]) -> Self {
        Self {
            significand: i16::from_ne_bytes(bytes),
        }
    }
    ...
    pub const fn from_be_bytes(bytes: [u8; 2]) -> Self {
        Self {
            significand: i16::from_be_bytes(bytes),
        }
    }
    ...
    pub const fn from_le_bytes(bytes: [u8; 2]) -> Self {
        Self {
            significand: i16::from_le_bytes(bytes),
        }
    }
    ...
    pub const fn overflowing_into_i8f(self) -> (I8F<E>, bool) {
        I8F::overflowing_from_i16f(self)
    }
    ...
    pub const fn overflowing_into_u8f(self) -> (U8F<E>, bool) {
        U8F::overflowing_from_i16f(self)
    }
    ...
    pub const fn saturating_into_u16f(self) -> U16F<E> {
        U16F::saturating_from_i16f(self)
    }
    ...
    pub const fn overflowing_into_u16f(self) -> (U16F<E>, bool) {
        U16F::overflowing_from_i16f(self)
    }
    ...
    pub const fn saturating_into_u32f(self) -> U32F<E> {
        U32F::saturating_from_i16f(self)
    }
    ...
    pub const fn overflowing_into_u32f(self) -> (U32F<E>, bool) {
        U32F::overflowing_from_i16f(self)
    }
    ...
    pub const fn saturating_into_u64f(self) -> U64F<E> {
        U64F::saturating_from_i16f(self)
    }
    ...
    pub const fn overflowing_into_u64f(self) -> (U64F<E>, bool) {
        U64F::overflowing_from_i16f(self)
    }
    ...
    pub const fn saturating_into_u128f(self) -> U128F<E> {
        U128F::saturating_from_i16f(self)
    }
    ...
    pub const fn overflowing_into_u128f(self) -> (U128F<E>, bool) {
        U128F::overflowing_from_i16f(self)
    }
    ...
    #[must_use]
    #[track_caller]
    pub const fn rescale<const E2: i32>(self) -> I16F<E2> {
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_rescale<const E2: i32>(self) -> I16F<E2> {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn wrapping_rescale<const E2: i32>(self) -> I16F<E2> {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn saturating_rescale<const E2: i32>(self) -> I16F<E2> {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn overflowing_rescale<const E2: i32>(self) -> (I16F<E2>, bool) {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn checked_rescale<const E2: i32>(self) -> Option<I16F<E2>> {
        let mut x = self.significand;
    ...
    #[must_use]
    #[track_caller]
    pub const fn add_unsigned(self, rhs: U16F<E>) -> Self {
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_add_unsigned(self, rhs: U16F<E>) -> Self {
        let x = self.significand.wrapping_add_unsigned(rhs.significand);
    ...
    /// Computes `self + rhs`, wrapping around at the numeric bounds of the type.
    #[must_use]
    pub const fn wrapping_add_unsigned(self, rhs: U16F<E>) -> Self {
        Self {
    ...
    /// Computes `self + rhs`, saturating at the numeric bounds of the type instead of overflowing.
    #[must_use]
    pub const fn saturating_add_unsigned(self, rhs: U16F<E>) -> Self {
        let x = self.significand.wrapping_add_unsigned(rhs.significand);
    ...
    /// Computes `self + rhs`. Returns a tuple of the wrapping result and a boolean indicating whether overflow occurred.
    #[must_use]
    pub const fn overflowing_add_unsigned(self, rhs: U16F<E>) -> (Self, bool) {
        let x = self.significand.wrapping_add_unsigned(rhs.significand);
    ...
    /// Computes `self + rhs`, returning `None` if overflow occurred.
    #[must_use]
    pub const fn checked_add_unsigned(self, rhs: U16F<E>) -> Option<Self> {
        let x = self.significand.wrapping_add_unsigned(rhs.significand);
    ...
    #[must_use]
    #[track_caller]
    pub const fn sub_unsigned(self, rhs: U16F<E>) -> Self {
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_sub_unsigned(self, rhs: U16F<E>) -> Self {
        let x = self.significand.wrapping_sub_unsigned(rhs.significand);
    ...
    /// Computes `self - rhs`, wrapping around at the numeric bounds of the type.
    #[must_use]
    pub const fn wrapping_sub_unsigned(self, rhs: U16F<E>) -> Self {
        Self {
    ...
    /// Computes `self - rhs`, saturating at the numeric bounds of the type instead of overflowing.
    #[must_use]
    pub const fn saturating_sub_unsigned(self, rhs: U16F<E>) -> Self {
        let x = self.significand.wrapping_sub_unsigned(rhs.significand);
    ...
    /// Computes `self - rhs`. Returns a tuple of the wrapping result and a boolean indicating whether overflow occurred.
    #[must_use]
    pub const fn overflowing_sub_unsigned(self, rhs: U16F<E>) -> (Self, bool) {
        let x = self.significand.wrapping_sub_unsigned(rhs.significand);
    ...
    /// Computes `self - rhs`, returning `None` if overflow occurred.
    #[must_use]
    pub const fn checked_sub_unsigned(self, rhs: U16F<E>) -> Option<Self> {
        let x = self.significand.wrapping_sub_unsigned(rhs.significand);
    ...
    #[must_use]
    #[track_caller]
    pub const fn mul<const R: i32>(self, rhs: I16F<R>) -> Self {
        ...
        if const { R > 0 } {
            ...
            if shift >= i32::BITS {
                ...
                let round = const {
                    ...
                    !(!0i32).unbounded_shl(shift.wrapping_sub(1))
                };
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_mul<const R: i32>(self, rhs: I16F<R>) -> Self {
        let mut x = (self.significand as i32).wrapping_mul(rhs.significand as i32);
    ...
    /// Computes `self * rhs`, wrapping around at the numeric bounds of the type.
    #[must_use]
    pub const fn wrapping_mul<const R: i32>(self, rhs: I16F<R>) -> Self {
        let mut x = (self.significand as i32).wrapping_mul(rhs.significand as i32);
    ...
    /// Computes `self * rhs`, saturating at the numeric bounds of the type instead of overflowing.
    #[must_use]
    pub const fn saturating_mul<const R: i32>(self, rhs: I16F<R>) -> Self {
        let mut x = (self.significand as i32).wrapping_mul(rhs.significand as i32);
    ...
    /// Computes `self * rhs`. Returns a tuple of the wrapping result and a boolean indicating whether overflow occurred.
    #[must_use]
    pub const fn overflowing_mul<const R: i32>(self, rhs: I16F<R>) -> (Self, bool) {
        let mut x = (self.significand as i32).wrapping_mul(rhs.significand as i32);
        let mut overflowed = false;
        ...
        overflowed |= x < i16::MIN as i32 || x > i16::MAX as i32;
    ...
    /// Computes `self * rhs`, returning `None` if overflow occurred.
    #[must_use]
    pub const fn checked_mul<const R: i32>(self, rhs: I16F<R>) -> Option<Self> {
        let mut x = (self.significand as i32).wrapping_mul(rhs.significand as i32);
    ...
    #[must_use]
    #[track_caller]
    pub const fn mul_unsigned<const R: i32>(self, rhs: U16F<R>) -> Self {
        let mut x = (self.significand as i32).wrapping_mul(rhs.significand as i32);
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_mul_unsigned<const R: i32>(self, rhs: U16F<R>) -> Self {
        let mut x = (self.significand as i32).wrapping_mul(rhs.significand as i32);
    ...
    /// Computes `self * rhs`, wrapping around at the numeric bounds of the type.
    #[must_use]
    pub const fn wrapping_mul_unsigned<const R: i32>(self, rhs: U16F<R>) -> Self {
        let mut x = (self.significand as i32).wrapping_mul(rhs.significand as i32);
    ...
    /// Computes `self * rhs`, saturating at the numeric bounds of the type instead of overflowing.
    #[must_use]
    pub const fn saturating_mul_unsigned<const R: i32>(self, rhs: U16F<R>) -> Self {
        let mut x = (self.significand as i32).wrapping_mul(rhs.significand as i32);
    ...
    /// Computes `self * rhs`. Returns a tuple of the wrapping result and a boolean indicating whether overflow occurred.
    #[must_use]
    pub const fn overflowing_mul_unsigned<const R: i32>(self, rhs: U16F<R>) -> (Self, bool) {
        let mut x = (self.significand as i32).wrapping_mul(rhs.significand as i32);
        let mut overflowed = false;
    ...
    /// Computes `self * rhs`, returning `None` if overflow occurred.
    #[must_use]
    pub const fn checked_mul_unsigned<const R: i32>(self, rhs: U16F<R>) -> Option<Self> {
        let mut x = (self.significand as i32).wrapping_mul(rhs.significand as i32);
    ...
    #[must_use]
    #[track_caller]
    pub const fn div<const R: i32>(self, rhs: I16F<R>) -> Self {
        const OFFSET: i32 = i16::BITS.cast_signed() - i32::BITS.cast_signed();

        let (x, overflowed) =
            ((self.significand as i32) << -OFFSET).overflowing_div(rhs.significand as i32);
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_div<const R: i32>(self, rhs: I16F<R>) -> Self {
        const OFFSET: i32 = i16::BITS.cast_signed() - i32::BITS.cast_signed();
        ...
        if x > (i16::MAX as u32).wrapping_add(negative as u32) {
            crate::panic::div();
        }
    ...
    #[must_use]
    #[track_caller]
    pub const fn wrapping_div<const R: i32>(self, rhs: I16F<R>) -> Self {
        const OFFSET: i32 = i16::BITS.cast_signed() - i32::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn saturating_div<const R: i32>(self, rhs: I16F<R>) -> Self {
        const OFFSET: i32 = i16::BITS.cast_signed() - i32::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn overflowing_div<const R: i32>(self, rhs: I16F<R>) -> (Self, bool) {
        const OFFSET: i32 = i16::BITS.cast_signed() - i32::BITS.cast_signed();
        ...
        overflowed |= x > (i16::MAX as u32).wrapping_add(negative as u32);
    ...
    #[must_use]
    pub const fn checked_div<const R: i32>(self, rhs: I16F<R>) -> Option<Self> {
        const OFFSET: i32 = i16::BITS.cast_signed() - i32::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn div_unsigned<const R: i32>(self, rhs: U16F<R>) -> Self {
        const OFFSET: i32 = i16::BITS.cast_signed() - i32::BITS.cast_signed();

        let mut x = ((self.significand as i32) << -OFFSET) / rhs.significand as i32;
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_div_unsigned<const R: i32>(self, rhs: U16F<R>) -> Self {
        const OFFSET: i32 = i16::BITS.cast_signed() - i32::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn wrapping_div_unsigned<const R: i32>(self, rhs: U16F<R>) -> Self {
        const OFFSET: i32 = i16::BITS.cast_signed() - i32::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn saturating_div_unsigned<const R: i32>(self, rhs: U16F<R>) -> Self {
        const OFFSET: i32 = i16::BITS.cast_signed() - i32::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn overflowing_div_unsigned<const R: i32>(self, rhs: U16F<R>) -> (Self, bool) {
        const OFFSET: i32 = i16::BITS.cast_signed() - i32::BITS.cast_signed();
    ...
    /// Computes `self / rhs`, returning `None` if `rhs == 0` or overflow occurred.
    #[must_use]
    pub const fn checked_div_unsigned<const R: i32>(self, rhs: U16F<R>) -> Option<Self> {
        const OFFSET: i32 = i16::BITS.cast_signed() - i32::BITS.cast_signed();
...
impl<const E: i32> ops::Neg for I16F<E> {
    type Output = Self;
...
impl<const E: i32> ops::Add for I16F<E> {
    type Output = Self;
...
impl<const E: i32> ops::Add<U16F<E>> for I16F<E> {
    type Output = Self;

    #[track_caller]
    fn add(self, rhs: U16F<E>) -> Self::Output {
        Self::add_unsigned(self, rhs)
    }
}

impl<const E: i32> ops::Sub for I16F<E> {
    type Output = Self;
...
impl<const E: i32> ops::Sub<U16F<E>> for I16F<E> {
    type Output = Self;

    #[track_caller]
    fn sub(self, rhs: U16F<E>) -> Self::Output {
        Self::sub_unsigned(self, rhs)
    }
}

impl<const E: i32, const R: i32> ops::Mul<I16F<R>> for I16F<E> {
    type Output = Self;
...
impl<const E: i32, const R: i32> ops::Mul<U16F<R>> for I16F<E> {
    type Output = Self;
...
impl<const E: i32, const R: i32> ops::Div<I16F<R>> for I16F<E> {
    type Output = Self;
...
impl<const E: i32, const R: i32> ops::Div<U16F<R>> for I16F<E> {
    type Output = Self;
...
impl<const E: i32> ops::AddAssign for I16F<E> {
    #[track_caller]
...
impl<const E: i32> ops::AddAssign<U16F<E>> for I16F<E> {
    #[track_caller]
    fn add_assign(&mut self, rhs: U16F<E>) {
        *self = Self::add_unsigned(*self, rhs)
    }
}

impl<const E: i32> ops::SubAssign for I16F<E> {
    #[track_caller]
...
impl<const E: i32> ops::SubAssign<U16F<E>> for I16F<E> {
    #[track_caller]
    fn sub_assign(&mut self, rhs: U16F<E>) {
        *self = Self::sub_unsigned(*self, rhs)
    }
}

impl<const E: i32, const R: i32> ops::MulAssign<I16F<R>> for I16F<E> {
    #[track_caller]
...
impl<const E: i32, const R: i32> ops::MulAssign<U16F<R>> for I16F<E> {
    #[track_caller]
...
impl<const E: i32, const R: i32> ops::DivAssign<I16F<R>> for I16F<E> {
    #[track_caller]
...
impl<const E: i32, const R: i32> ops::DivAssign<U16F<R>> for I16F<E> {
    #[track_caller]
