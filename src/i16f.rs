...
impl<const E: i32> I16F<E> {
    ...
    pub const fn from_i8f(value: I8F<E>) -> Self {
        Self {
            significand: value.significand as i16,
        }
    }
...
impl I16F<-15> {
    ...
    pub const fn cospi_2(self) -> I16F<-14> {
        I16F {
            significand: crate::algorithm::cospi_i16_2(self.significand),
        }
    }
    ...
    pub const fn cospi_4(self) -> I16F<-14> {
        I16F {
            significand: crate::algorithm::cospi_i16_4(self.significand),
        }
    }
    ...
    pub const fn cospi_6(self) -> I16F<-14> {
        I16F {
            significand: crate::algorithm::cospi_i16_6(self.significand),
        }
    }
    ...
    pub const fn sinpi_2(self) -> I16F<-14> {
        I16F {
            significand: crate::algorithm::cospi_i16_2(
                self.significand.wrapping_add_unsigned(0xC000),
            ),
        }
    }
    ...
    pub const fn sinpi_4(self) -> I16F<-14> {
        I16F {
            significand: crate::algorithm::cospi_i16_4(
                self.significand.wrapping_add_unsigned(0xC000),
            ),
        }
    }
    ...
    pub const fn sinpi_6(self) -> I16F<-14> {
        I16F {
            significand: crate::algorithm::cospi_i16_6(
                self.significand.wrapping_add_unsigned(0xC000),
            ),
        }
    }
