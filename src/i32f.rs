...
impl<const E: i32> I32F<E> {
    ...
    pub const fn costau_2(self) -> I32F<-30> {
        self.wrapping_rescale()._costau_2()
    }
    ...
    pub const fn costau_4(self) -> I32F<-30> {
        self.wrapping_rescale()._costau_4()
    }
    ...
    pub const fn costau_6(self) -> I32F<-30> {
        self.wrapping_rescale()._costau_6()
    }
    ...
    pub const fn costau_8(self) -> I32F<-30> {
        self.wrapping_rescale()._costau_8()
    }
    ...
    pub const fn costau_10(self) -> I32F<-30> {
        self.wrapping_rescale()._costau_10()
    }
    ...
    pub const fn sintau_2(self) -> I32F<-30> {
        self.wrapping_rescale()
            .wrapping_add(const { I32F::from_bits(0xC0000000) })
            ._costau_2()
    }
...
impl I32F<-32> {
    #[must_use]
    const fn _costau_2(self) -> I32F<-30> {
        const A_0: u64 = 0x1000000000000000;
        const E_0: i32 = -60;
        const E_OUT: i32 = -30;

        let theta = self.0.cast_unsigned();
    ...
    #[must_use]
    const fn _costau_4(self) -> I32F<-30> {
    ...
    #[must_use]
    const fn _costau_6(self) -> I32F<-30> {
        const A_0: u64 = 0x8000000000000000;
    ...
    #[must_use]
    const fn _costau_8(self) -> I32F<-30> {
        const A_0: u64 = 0x8000000000000000;
    ...
    #[must_use]
    const fn _costau_10(self) -> I32F<-30> {
        const A_0: u64 = 0x8000000000000000;
