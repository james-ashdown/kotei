...
pub struct U8F<const E: i32> {
    pub(crate) significand: u8,
}

impl U8F<-10> {
    /// 1/τ
    pub const FRAC_1_TAU: Self = Self { significand: 0xA3 };
}

impl U8F<-9> {
    /// 1/π
    pub const FRAC_1_PI: Self = Self { significand: 0xA3 };
    /// π/8
    pub const FRAC_PI_8: Self = Self { significand: 0xC9 };
    /// log<sub>10</sub>(2)
    pub const LOG10_2: Self = Self { significand: 0x9A };
    /// log<sub>10</sub>(e)
    pub const LOG10_E: Self = Self { significand: 0xDE };
}

impl U8F<-8> {
    /// The Euler-Mascheroni constant (γ)
    pub const EULER_GAMMA: Self = Self { significand: 0x94 };
    /// 1/sqrt(2)
    pub const FRAC_1_SQRT_2: Self = Self { significand: 0xB5 };
    /// 2/π
    pub const FRAC_2_PI: Self = Self { significand: 0xA3 };
    /// π/4
    pub const FRAC_PI_4: Self = Self { significand: 0xC9 };
    /// π/6
    pub const FRAC_PI_6: Self = Self { significand: 0x86 };
    /// ln(2)
    pub const LN_2: Self = Self { significand: 0xB1 };
}

impl U8F<-7> {
    /// 2/sqrt(π)
    pub const FRAC_2_SQRT_PI: Self = Self { significand: 0x90 };
    /// π/2
    pub const FRAC_PI_2: Self = Self { significand: 0xC9 };
    /// π/3
    pub const FRAC_PI_3: Self = Self { significand: 0x86 };
    /// The golden ratio (φ)
    pub const GOLDEN_RATIO: Self = Self { significand: 0xCF };
    /// log<sub>2</sub>(e)
    pub const LOG2_E: Self = Self { significand: 0xB9 };
    /// sqrt(2)
    pub const SQRT_2: Self = Self { significand: 0xB5 };
}

impl U8F<-6> {
    /// Euler's number (e)
    pub const E: Self = Self { significand: 0xAE };
    /// ln(10)
    pub const LN_10: Self = Self { significand: 0x93 };
    /// log<sub>2</sub>(10)
    pub const LOG2_10: Self = Self { significand: 0xD5 };
    /// Archimedes’ constant (π)
    pub const PI: Self = Self { significand: 0xC9 };
}

impl U8F<-5> {
    /// The full circle constant (τ)
    pub const TAU: Self = Self { significand: 0xC9 };
}
...
impl<const E: i32> U8F<E> {
    ...
    pub const fn try_from_f32(value: f32) -> Result<Self, TryFromFloatError> {
        ...
        if sign != 0 && significand > 0 || significand > u8::MAX as u32 {
            return Err(TryFromFloatError::Overflow);
        }

        let significand = significand as u8;
    ...
    pub const fn try_from_f64(value: f64) -> Result<Self, TryFromFloatError> {
        ...
        if sign != 0 && significand > 0 || significand > u8::MAX as u64 {
            return Err(TryFromFloatError::Overflow);
        }
    ...
    pub const fn from_i8f(value: I8F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand < u8::MIN as i8 {
            crate::panic::from();
        }

        let significand = value.significand as u8;
    ...
    pub const fn strict_from_i8f(value: I8F<E>) -> Self {
        if value.significand < u8::MIN as i8 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_i8f(value: I8F<E>) -> (Self, bool) {
        let overflowed = value.significand < u8::MIN as i8;
        let significand = value.significand as u8;
    ...
    pub const fn from_i16f(value: I16F<E>) -> Self {
        if cfg!(debug_assertions)
            && (value.significand < u8::MIN as i16 || value.significand > u8::MAX as i16)
        {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i16f(value: I16F<E>) -> Self {
        if value.significand < u8::MIN as i16 || value.significand > u8::MAX as i16 {
            crate::panic::from();
        }
    ...
    pub const fn saturating_from_i16f(value: I16F<E>) -> Self {
        if value.significand < u8::MIN as i16 {
            return Self::MIN;
        } else if value.significand > u8::MAX as i16 {
            return Self::MAX;
        }
    ...
    pub const fn overflowing_from_i16f(value: I16F<E>) -> (Self, bool) {
        let overflowed = value.significand < u8::MIN as i16 || value.significand > u8::MAX as i16;
        let significand = value.significand as u8;
    ...
    pub const fn from_i32f(value: I32F<E>) -> Self {
        if cfg!(debug_assertions)
            && (value.significand < u8::MIN as i32 || value.significand > u8::MAX as i32)
        {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i32f(value: I32F<E>) -> Self {
        if value.significand < u8::MIN as i32 || value.significand > u8::MAX as i32 {
            crate::panic::from();
        }
    ...
    pub const fn saturating_from_i32f(value: I32F<E>) -> Self {
        if value.significand < u8::MIN as i32 {
            return Self::MIN;
        } else if value.significand > u8::MAX as i32 {
            return Self::MAX;
        }
    ...
    pub const fn overflowing_from_i32f(value: I32F<E>) -> (Self, bool) {
        let overflowed = value.significand < u8::MIN as i32 || value.significand > u8::MAX as i32;
        let significand = value.significand as u8;
    ...
    pub const fn from_i64f(value: I64F<E>) -> Self {
        if cfg!(debug_assertions)
            && (value.significand < u8::MIN as i64 || value.significand > u8::MAX as i64)
        {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i64f(value: I64F<E>) -> Self {
        if value.significand < u8::MIN as i64 || value.significand > u8::MAX as i64 {
            crate::panic::from();
        }
    ...
    pub const fn saturating_from_i64f(value: I64F<E>) -> Self {
        if value.significand < u8::MIN as i64 {
            return Self::MIN;
        } else if value.significand > u8::MAX as i64 {
            return Self::MAX;
        }
    ...
    pub const fn overflowing_from_i64f(value: I64F<E>) -> (Self, bool) {
        let overflowed = value.significand < u8::MIN as i64 || value.significand > u8::MAX as i64;
        let significand = value.significand as u8;
    ...
    pub const fn from_i128f(value: I128F<E>) -> Self {
        if cfg!(debug_assertions)
            && (value.significand < u8::MIN as i128 || value.significand > u8::MAX as i128)
        {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i128f(value: I128F<E>) -> Self {
        if value.significand < u8::MIN as i128 || value.significand > u8::MAX as i128 {
            crate::panic::from();
        }
    ...
    pub const fn saturating_from_i128f(value: I128F<E>) -> Self {
        if value.significand < u8::MIN as i128 {
            return Self::MIN;
        } else if value.significand > u8::MAX as i128 {
            return Self::MAX;
        }
    ...
    pub const fn overflowing_from_i128f(value: I128F<E>) -> (Self, bool) {
        let overflowed = value.significand < u8::MIN as i128 || value.significand > u8::MAX as i128;
        let significand = value.significand as u8;
    ...
    pub const fn from_u16f(value: U16F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand > u8::MAX as u16 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_u16f(value: U16F<E>) -> Self {
        if value.significand > u8::MAX as u16 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_u16f(value: U16F<E>) -> (Self, bool) {
        let overflowed = value.significand > u8::MAX as u16;
        let significand = value.significand as u8;
    ...
    pub const fn from_u32f(value: U32F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand > u8::MAX as u32 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_u32f(value: U32F<E>) -> Self {
        if value.significand > u8::MAX as u32 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_u32f(value: U32F<E>) -> (Self, bool) {
        let overflowed = value.significand > u8::MAX as u32;
        let significand = value.significand as u8;
    ...
    pub const fn from_u64f(value: U64F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand > u8::MAX as u64 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_u64f(value: U64F<E>) -> Self {
        if value.significand > u8::MAX as u64 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_u64f(value: U64F<E>) -> (Self, bool) {
        let overflowed = value.significand > u8::MAX as u64;
        let significand = value.significand as u8;
    ...
    pub const fn from_u128f(value: U128F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand > u8::MAX as u128 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_u128f(value: U128F<E>) -> Self {
        if value.significand > u8::MAX as u128 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_u128f(value: U128F<E>) -> (Self, bool) {
        let overflowed = value.significand > u8::MAX as u128;
        let significand = value.significand as u8;
    ...
    pub const fn from_ne_bytes(bytes: [u8; 1]) -> Self {
        Self {
            significand: u8::from_ne_bytes(bytes),
        }
    }
    ...
    pub const fn from_be_bytes(bytes: [u8; 1]) -> Self {
        Self {
            significand: u8::from_be_bytes(bytes),
        }
    }
    ...
    pub const fn from_le_bytes(bytes: [u8; 1]) -> Self {
        Self {
            significand: u8::from_le_bytes(bytes),
        }
    }
    ...
    #[must_use]
    #[track_caller]
    pub const fn rescale<const E2: i32>(self) -> U8F<E2> {
        ...
        if const { E > E2 } {
            ...
            if shift >= u8::BITS {
                x = 0;
            } else if shift == u8::BITS {
                let threshold = const { 1 << (u8::BITS - 1) };
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_rescale<const E2: i32>(self) -> U8F<E2> {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn wrapping_rescale<const E2: i32>(self) -> U8F<E2> {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn saturating_rescale<const E2: i32>(self) -> U8F<E2> {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn overflowing_rescale<const E2: i32>(self) -> (U8F<E2>, bool) {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn checked_rescale<const E2: i32>(self) -> Option<U8F<E2>> {
        let mut x = self.significand;
    ...
    pub const fn add_signed(self, rhs: I8F<E>) -> Self {
        let x = self.significand.wrapping_add(rhs.significand as u8);
    ...
    pub const fn wrapping_add_signed(self, rhs: I8F<E>) -> Self {
        Self {
            significand: self.significand.wrapping_add(rhs.significand as u8),
        }
    }
    ...
    pub const fn sub_signed(self, rhs: I8F<E>) -> Self {
        let x = self.significand.wrapping_sub(rhs.significand as u8);
    ...
    pub const fn wrapping_sub_signed(self, rhs: I8F<E>) -> Self {
        Self {
            significand: self.significand.wrapping_sub(rhs.significand as u8),
        }
    }
    ...
    #[must_use]
    #[track_caller]
    pub const fn mul<const R: i32>(self, rhs: U8F<R>) -> Self {
        let mut x = (self.significand as u16).wrapping_mul(rhs.significand as u16);
        ...
        if cfg!(debug_assertions) && x > u8::MAX as u16 {
            crate::panic::mul();
        }
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_mul<const R: i32>(self, rhs: U8F<R>) -> Self {
        let mut x = (self.significand as u16).wrapping_mul(rhs.significand as u16);
    ...
    /// Computes `self * rhs`, wrapping around at the numeric bounds of the type.
    #[must_use]
    pub const fn wrapping_mul<const R: i32>(self, rhs: U8F<R>) -> Self {
        let mut x = (self.significand as u16).wrapping_mul(rhs.significand as u16);
    ...
    /// Computes `self * rhs`, saturating at the numeric bounds of the type instead of overflowing.
    #[must_use]
    pub const fn saturating_mul<const R: i32>(self, rhs: U8F<R>) -> Self {
        let mut x = (self.significand as u16).wrapping_mul(rhs.significand as u16);
    ...
    /// Computes `self * rhs`. Returns a tuple of the wrapping result and a boolean indicating whether overflow occurred.
    #[must_use]
    pub const fn overflowing_mul<const R: i32>(self, rhs: U8F<R>) -> (Self, bool) {
        let mut x = (self.significand as u16).wrapping_mul(rhs.significand as u16);
        let mut overflowed = false;
    ...
    /// Computes `self * rhs`, returning `None` if overflow occurred.
    #[must_use]
    pub const fn checked_mul<const R: i32>(self, rhs: U8F<R>) -> Option<Self> {
        let mut x = (self.significand as u16).wrapping_mul(rhs.significand as u16);
    ...
    #[must_use]
    #[track_caller]
    pub const fn mul_signed<const R: i32>(self, rhs: I8F<R>) -> Self {
        ...
        if cfg!(debug_assertions) && (x < u8::MIN as i16 || x > u8::MAX as i16) {
            crate::panic::mul();
        }
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_mul_signed<const R: i32>(self, rhs: I8F<R>) -> Self {
        let mut x = (self.significand as i16).wrapping_mul(rhs.significand as i16);
        ...
        if x < u8::MIN as i16 || x > u8::MAX as i16 {
            crate::panic::mul();
        }
    ...
    /// Computes `self * rhs`, wrapping around at the numeric bounds of the type.
    #[must_use]
    pub const fn wrapping_mul_signed<const R: i32>(self, rhs: I8F<R>) -> Self {
        let mut x = (self.significand as i16).wrapping_mul(rhs.significand as i16);
    ...
    /// Computes `self * rhs`, saturating at the numeric bounds of the type instead of overflowing.
    #[must_use]
    pub const fn saturating_mul_signed<const R: i32>(self, rhs: I8F<R>) -> Self {
        let mut x = (self.significand as i16).wrapping_mul(rhs.significand as i16);
    ...
    /// Computes `self * rhs`. Returns a tuple of the wrapping result and a boolean indicating whether overflow occurred.
    #[must_use]
    pub const fn overflowing_mul_signed<const R: i32>(self, rhs: I8F<R>) -> (Self, bool) {
        let mut x = (self.significand as i16).wrapping_mul(rhs.significand as i16);
        let mut overflowed = false;
        ...
        overflowed |= x < u8::MIN as i16 || x > u8::MAX as i16;
    ...
    /// Computes `self * rhs`, returning `None` if overflow occurred.
    #[must_use]
    pub const fn checked_mul_signed<const R: i32>(self, rhs: I8F<R>) -> Option<Self> {
        let mut x = (self.significand as i16).wrapping_mul(rhs.significand as i16);
    ...
    #[must_use]
    #[track_caller]
    pub const fn div<const R: i32>(self, rhs: U8F<R>) -> Self {
        const OFFSET: i32 = u8::BITS.cast_signed() - u16::BITS.cast_signed();

        let mut x = ((self.significand as u16) << -OFFSET) / rhs.significand as u16;
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_div<const R: i32>(self, rhs: U8F<R>) -> Self {
        const OFFSET: i32 = u8::BITS.cast_signed() - u16::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn wrapping_div<const R: i32>(self, rhs: U8F<R>) -> Self {
        const OFFSET: i32 = u8::BITS.cast_signed() - u16::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn saturating_div<const R: i32>(self, rhs: U8F<R>) -> Self {
        const OFFSET: i32 = u8::BITS.cast_signed() - u16::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn overflowing_div<const R: i32>(self, rhs: U8F<R>) -> (Self, bool) {
        const OFFSET: i32 = u8::BITS.cast_signed() - u16::BITS.cast_signed();
    ...
    #[must_use]
    pub const fn checked_div<const R: i32>(self, rhs: U8F<R>) -> Option<Self> {
        const OFFSET: i32 = u8::BITS.cast_signed() - u16::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn div_signed<const R: i32>(self, rhs: I8F<R>) -> Self {
        const OFFSET: i32 = u8::BITS.cast_signed() - u16::BITS.cast_signed();

        let negative = rhs.significand < 0;
        let mut rhs = rhs.significand as u8;

        if negative {
            rhs = rhs.wrapping_neg();
        }

        let mut x = ((self.significand as u16) << -OFFSET) / rhs as u16;
        ...
        if cfg!(debug_assertions) {
            if (negative && x != 0) || x > u8::MAX as u16 {
                crate::panic::div();
            }
        } else {
            if negative {
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_div_signed<const R: i32>(self, rhs: I8F<R>) -> Self {
        const OFFSET: i32 = u8::BITS.cast_signed() - u16::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn wrapping_div_signed<const R: i32>(self, rhs: I8F<R>) -> Self {
        const OFFSET: i32 = u8::BITS.cast_signed() - u16::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn saturating_div_signed<const R: i32>(self, rhs: I8F<R>) -> Self {
        const OFFSET: i32 = u8::BITS.cast_signed() - u16::BITS.cast_signed();
    ...
    #[must_use]
    #[track_caller]
    pub const fn overflowing_div_signed<const R: i32>(self, rhs: I8F<R>) -> (Self, bool) {
        const OFFSET: i32 = u8::BITS.cast_signed() - u16::BITS.cast_signed();
        ...
        overflowed |= (negative && x != 0) || x > u8::MAX as u16;
    ...
    /// Computes `self / rhs`, returning `None` if `rhs == 0` or overflow occurred.
    #[must_use]
    pub const fn checked_div_signed<const R: i32>(self, rhs: I8F<R>) -> Option<Self> {
        const OFFSET: i32 = u8::BITS.cast_signed() - u16::BITS.cast_signed();
...
impl U8F<-7> {
    ...
    pub const fn cospi_2(self) -> I8F<-6> {
        let theta = self.significand as i8;
    ...
    pub const fn sinpi_2(self) -> I8F<-6> {
        ...
        let theta = (self.significand as i8).wrapping_add(PHASE_SHIFT);
        let significand = crate::algorithm::cospi_i8_2(theta);
...
impl<const E: i32> ops::Add<I8F<E>> for U8F<E> {
    type Output = Self;

    #[track_caller]
    fn add(self, rhs: I8F<E>) -> Self::Output {
...
impl<const E: i32> ops::Sub<I8F<E>> for U8F<E> {
    type Output = Self;

    #[track_caller]
    fn sub(self, rhs: I8F<E>) -> Self::Output {
...
impl<const E: i32> ops::AddAssign<I8F<E>> for U8F<E> {
    #[track_caller]
    fn add_assign(&mut self, rhs: I8F<E>) {
        *self = Self::add_signed(*self, rhs)
    }
}

impl<const E: i32> ops::SubAssign for U8F<E> {
    #[track_caller]
...
impl<const E: i32> ops::SubAssign<I8F<E>> for U8F<E> {
    #[track_caller]
    fn sub_assign(&mut self, rhs: I8F<E>) {
        *self = Self::sub_signed(*self, rhs)
    }
}

impl<const E: i32, const R: i32> ops::MulAssign<U8F<R>> for U8F<E> {
    #[track_caller]
...
impl<const E: i32, const R: i32> ops::MulAssign<I8F<R>> for U8F<E> {
    #[track_caller]
...
impl<const E: i32, const R: i32> ops::DivAssign<U8F<R>> for U8F<E> {
    #[track_caller]
...
impl<const E: i32, const R: i32> ops::DivAssign<I8F<R>> for U8F<E> {
    #[track_caller]
