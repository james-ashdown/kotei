...
impl<const E: i32> U32F<E> {
    ...
    pub const fn try_new_from_f64(value: f64) -> Result<Self, TryFromFloatError> {
        ...
        Ok(Self {
            significand: significand as u32,
        })
    }
    ...
    pub const fn from_i8f(value: I8F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand < u32::MIN as i8 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i8f(value: I8F<E>) -> Self {
        if value.significand < u32::MIN as i8 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_i8f(value: I8F<E>) -> (Self, bool) {
        let overflowed = value.significand < u32::MIN as i8;
        let significand = value.significand as u32;
    ...
    pub const fn from_i16f(value: I16F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand < u32::MIN as i16 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i16f(value: I16F<E>) -> Self {
        if value.significand < u32::MIN as i16 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_i16f(value: I16F<E>) -> (Self, bool) {
        let overflowed = value.significand < u32::MIN as i16;
        let significand = value.significand as u32;
    ...
    pub const fn from_i32f(value: I32F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand < u32::MIN as i32 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i32f(value: I32F<E>) -> Self {
        if value.significand < u32::MIN as i32 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_i32f(value: I32F<E>) -> (Self, bool) {
        let overflowed = value.significand < u32::MIN as i32;
        let significand = value.significand as u32;
    ...
    pub const fn from_i64f(value: I64F<E>) -> Self {
        if cfg!(debug_assertions)
            && (value.significand < u32::MIN as i64 || value.significand > u32::MAX as i64)
        {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i64f(value: I64F<E>) -> Self {
        if value.significand < u32::MIN as i64 || value.significand > u32::MAX as i64 {
            crate::panic::from();
        }
    ...
    pub const fn saturating_from_i64f(value: I64F<E>) -> Self {
        if value.significand < u32::MIN as i64 {
            return Self::MIN;
        } else if value.significand > u32::MAX as i64 {
            return Self::MAX;
        }
    ...
    pub const fn overflowing_from_i64f(value: I64F<E>) -> (Self, bool) {
        let overflowed = value.significand < u32::MIN as i64 || value.significand > u32::MAX as i64;
        let significand = value.significand as u32;
    ...
    pub const fn from_i128f(value: I128F<E>) -> Self {
        if cfg!(debug_assertions)
            && (value.significand < u32::MIN as i128 || value.significand > u32::MAX as i128)
        {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i128f(value: I128F<E>) -> Self {
        if value.significand < u32::MIN as i128 || value.significand > u32::MAX as i128 {
            crate::panic::from();
        }
    ...
    pub const fn saturating_from_i128f(value: I128F<E>) -> Self {
        if value.significand < u32::MIN as i128 {
            return Self::MIN;
        } else if value.significand > u32::MAX as i128 {
            return Self::MAX;
        }
    ...
    pub const fn from_u64f(value: U64F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand > u32::MAX as u64 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_u64f(value: U64F<E>) -> Self {
        if value.significand > u32::MAX as u64 {
            crate::panic::from();
        }
    ...
    pub const fn from_u128f(value: U128F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand > u32::MAX as u128 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_u128f(value: U128F<E>) -> Self {
        if value.significand > u32::MAX as u128 {
            crate::panic::from();
        }
    ...
    pub const fn mul<const R: i32>(self, rhs: U32F<R>) -> Self {
        let mut x = (self.significand as u64).wrapping_mul(rhs.significand as u64);
        ...
        if cfg!(debug_assertions) && x > u32::MAX as u64 {
            crate::panic::mul();
        }
    ...
    pub const fn mul_signed<const R: i32>(self, rhs: I32F<R>) -> Self {
        ...
        if cfg!(debug_assertions) && (x < u32::MIN as i64 || x > u32::MAX as i64) {
            crate::panic::mul();
        }
    ...
    pub const fn strict_mul_signed<const R: i32>(self, rhs: I32F<R>) -> Self {
        ...
        if x < u32::MIN as i64 || x > u32::MAX as i64 {
            crate::panic::mul();
        }
    ...
    pub const fn overflowing_mul_signed<const R: i32>(self, rhs: I32F<R>) -> (Self, bool) {
        ...
        overflowed |= x < u32::MIN as i64 || x > u32::MAX as i64;
    ...
    pub const fn div_signed<const R: i32>(self, rhs: I32F<R>) -> Self {
        ...
        if cfg!(debug_assertions) {
            if (negative && x != 0) || x > u32::MAX as u64 {
                crate::panic::div();
            }
        } else {
            if negative {
