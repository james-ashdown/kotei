...
impl<const E: i32> U32F<E> {
    ...
    pub const fn add_signed(self, rhs: I32F<E>) -> Self {
        let x = self.0.wrapping_add(rhs.0 as u32);
    ...
    pub const fn wrapping_add_signed(self, rhs: I32F<E>) -> Self {
        Self(self.0.wrapping_add(rhs.0 as u32))
    }
    ...
    pub const fn sub_signed(self, rhs: I32F<E>) -> Self {
        let x = self.0.wrapping_sub(rhs.0 as u32);
    ...
    pub const fn wrapping_sub_signed(self, rhs: I32F<E>) -> Self {
        Self(self.0.wrapping_sub(rhs.0 as u32))
    }
    ...
    pub const fn mul<const R: i32>(self, rhs: U32F<R>) -> Self {
        let mut x = (self.0 as u64).wrapping_mul(rhs.0 as u64);
    ...
    pub const fn mul_signed<const R: i32>(self, rhs: I32F<R>) -> Self {
        let mut x = (self.0 as i64).wrapping_mul(rhs.0 as i64);
    ...
    pub const fn div<const R: i32>(self, rhs: U32F<R>) -> Self {
        ...
        let mut x = ((self.0 as u64) << -OFFSET) / rhs.0 as u64;
    ...
    pub const fn div_signed<const R: i32>(self, rhs: I32F<R>) -> Self {
        ...
        let mut rhs = rhs.0 as u32;

        if negative {
            rhs = rhs.wrapping_neg();
        }

        let mut x = ((self.0 as u64) << -OFFSET) / rhs as u64;
...
impl U32F<-31> {
    ...
    pub const fn cospi_2(self) -> I32F<-30> {
        I32F(crate::algorithm::cospi_i32_2(self.0 as i32))
    }
    ...
    pub const fn cospi_4(self) -> I32F<-30> {
        I32F(crate::algorithm::cospi_i32_4(self.0 as i32))
    }
    ...
    pub const fn cospi_6(self) -> I32F<-30> {
        I32F(crate::algorithm::cospi_i32_6(self.0 as i32))
    }
    ...
    pub const fn cospi_8(self) -> I32F<-30> {
        I32F(crate::algorithm::cospi_i32_8(self.0 as i32))
    }
    ...
    pub const fn cospi_10(self) -> I32F<-30> {
        I32F(crate::algorithm::cospi_i32_10(self.0 as i32))
    }
    ...
    pub const fn sinpi_2(self) -> I32F<-30> {
        I32F(crate::algorithm::cospi_i32_2(
            self.0.wrapping_add(0xC0000000) as i32,
        ))
    }
