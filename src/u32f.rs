...
impl<const E: i32> U32F<E> {
    ...
    pub const fn from_u8f(value: U8F<E>) -> Self {
        Self {
            significand: value.significand as u32,
        }
    }
...
impl U32F<-31> {
    ...
    pub const fn cospi_2(self) -> I32F<-30> {
        I32F {
            significand: crate::algorithm::cospi_i32_2(self.significand as i32),
        }
    }
    ...
    pub const fn cospi_4(self) -> I32F<-30> {
        I32F {
            significand: crate::algorithm::cospi_i32_4(self.significand as i32),
        }
    }
    ...
    pub const fn cospi_6(self) -> I32F<-30> {
        I32F {
            significand: crate::algorithm::cospi_i32_6(self.significand as i32),
        }
    }
    ...
    pub const fn cospi_8(self) -> I32F<-30> {
        I32F {
            significand: crate::algorithm::cospi_i32_8(self.significand as i32),
        }
    }
    ...
    pub const fn cospi_10(self) -> I32F<-30> {
        I32F {
            significand: crate::algorithm::cospi_i32_10(self.significand as i32),
        }
    }
    ...
    pub const fn sinpi_2(self) -> I32F<-30> {
        I32F {
            significand: crate::algorithm::cospi_i32_2(
                self.significand.wrapping_add(0xC0000000) as i32
            ),
        }
    }
