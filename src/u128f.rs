...
impl U128F<-130> {
    ...
    pub const FRAC_1_TAU: Self = Self {
        significand: 0xA2F9836E4E441529FC2757D1F534DDC1,
    };
}
...
impl U128F<-129> {
    ...
    pub const FRAC_PI_8: Self = Self {
        significand: 0xC90FDAA22168C234C4C6628B80DC1CD1,
    };
    /// log<sub>10</sub>(2)
    pub const LOG10_2: Self = Self {
        significand: 0x9A209A84FBCFF7988F8959AC0B7C9178,
    };
    /// log<sub>10</sub>(e)
    pub const LOG10_E: Self = Self {
        significand: 0xDE5BD8A937287195355BAAAFAD33DC32,
    };
}
...
impl U128F<-128> {
    ...
    pub const EULER_GAMMA: Self = Self {
        significand: 0x93C467E37DB0C7A4D1BE3F810152CB57,
    };
    /// 1/sqrt(2)
    pub const FRAC_1_SQRT_2: Self = Self {
        significand: 0xB504F333F9DE6484597D89B3754ABE9F,
    };
    /// 2/π
    ...
    pub const FRAC_PI_6: Self = Self {
        significand: 0x860A91C16B9B2C232DD99707AB3D688B,
    };
    /// ln(2)
    pub const LN_2: Self = Self {
        significand: 0xB17217F7D1CF79ABC9E3B39803F2F6AF,
    };
}
...
impl U128F<-127> {
    ...
    pub const FRAC_2_SQRT_PI: Self = Self {
        significand: 0x906EBA8214DB688D71D48A7F6BFEC344,
    };
    /// π/2
    ...
    pub const GOLDEN_RATIO: Self = Self {
        significand: 0xCF1BBCDCBFA53E0AF9CE60302E76E41A,
    };
    /// log<sub>2</sub>(e)
    pub const LOG2_E: Self = Self {
        significand: 0xB8AA3B295C17F0BBBE87FED0691D3E89,
    };
    /// sqrt(2)
...
impl U128F<-126> {
    ...
    pub const E: Self = Self {
        significand: 0xADF85458A2BB4A9AAFDC5620273D3CF2,
    };
    /// ln(10)
    pub const LN_10: Self = Self {
        significand: 0x935D8DDDAAA8AC16EA56D62B82D30A29,
    };
    /// log<sub>2</sub>(10)
    pub const LOG2_10: Self = Self {
        significand: 0xD49A784BCD1B8AFE492BF6FF4DAFDB4D,
    };
...
impl<const E: i32> U128F<E> {
    ...
    pub const fn from_i8f(value: I8F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand < u128::MIN as i8 {
            crate::panic::from();
        }

        let significand = value.significand as u128;
    ...
    pub const fn strict_from_i8f(value: I8F<E>) -> Self {
        if value.significand < u128::MIN as i8 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_i8f(value: I8F<E>) -> (Self, bool) {
        let overflowed = value.significand < u128::MIN as i8;
        let significand = value.significand as u128;
    ...
    pub const fn from_i16f(value: I16F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand < u128::MIN as i16 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i16f(value: I16F<E>) -> Self {
        if value.significand < u128::MIN as i16 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_i16f(value: I16F<E>) -> (Self, bool) {
        let overflowed = value.significand < u128::MIN as i16;
        let significand = value.significand as u128;
    ...
    pub const fn from_i32f(value: I32F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand < u128::MIN as i32 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i32f(value: I32F<E>) -> Self {
        if value.significand < u128::MIN as i32 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_i32f(value: I32F<E>) -> (Self, bool) {
        let overflowed = value.significand < u128::MIN as i32;
        let significand = value.significand as u128;
    ...
    pub const fn from_i64f(value: I64F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand < u128::MIN as i64 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i64f(value: I64F<E>) -> Self {
        if value.significand < u128::MIN as i64 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_i64f(value: I64F<E>) -> (Self, bool) {
        let overflowed = value.significand < u128::MIN as i64;
        let significand = value.significand as u128;
    ...
    pub const fn from_i128f(value: I128F<E>) -> Self {
        if cfg!(debug_assertions) && value.significand < u128::MIN as i128 {
            crate::panic::from();
        }
    ...
    pub const fn strict_from_i128f(value: I128F<E>) -> Self {
        if value.significand < u128::MIN as i128 {
            crate::panic::from();
        }
    ...
    pub const fn overflowing_from_i128f(value: I128F<E>) -> (Self, bool) {
        let overflowed = value.significand < u128::MIN as i128;
        let significand = value.significand as u128;
    ...
    pub const fn from_ne_bytes(bytes: [u8; 16]) -> Self {
        Self {
            significand: u128::from_ne_bytes(bytes),
        }
    }
    ...
    pub const fn from_be_bytes(bytes: [u8; 16]) -> Self {
        Self {
            significand: u128::from_be_bytes(bytes),
        }
    }
    ...
    pub const fn from_le_bytes(bytes: [u8; 16]) -> Self {
        Self {
            significand: u128::from_le_bytes(bytes),
        }
    }
    ...
    pub const fn saturating_into_i8f(self) -> I8F<E> {
        I8F::saturating_from_u128f(self)
    }
    ...
    pub const fn overflowing_into_i8f(self) -> (I8F<E>, bool) {
        I8F::overflowing_from_u128f(self)
    }
    ...
    pub const fn saturating_into_i16f(self) -> I16F<E> {
        I16F::saturating_from_u128f(self)
    }
    ...
    pub const fn overflowing_into_i16f(self) -> (I16F<E>, bool) {
        I16F::overflowing_from_u128f(self)
    }
    ...
    pub const fn saturating_into_i32f(self) -> I32F<E> {
        I32F::saturating_from_u128f(self)
    }
    ...
    pub const fn overflowing_into_i32f(self) -> (I32F<E>, bool) {
        I32F::overflowing_from_u128f(self)
    }
    ...
    pub const fn saturating_into_i64f(self) -> I64F<E> {
        I64F::saturating_from_u128f(self)
    }
    ...
    pub const fn overflowing_into_i64f(self) -> (I64F<E>, bool) {
        I64F::overflowing_from_u128f(self)
    }
    ...
    pub const fn saturating_into_u8f(self) -> U8F<E> {
        U8F::saturating_from_u128f(self)
    }
    ...
    pub const fn overflowing_into_u8f(self) -> (U8F<E>, bool) {
        U8F::overflowing_from_u128f(self)
    }
    ...
    pub const fn saturating_into_u16f(self) -> U16F<E> {
        U16F::saturating_from_u128f(self)
    }
    ...
    pub const fn overflowing_into_u16f(self) -> (U16F<E>, bool) {
        U16F::overflowing_from_u128f(self)
    }
    ...
    pub const fn saturating_into_u32f(self) -> U32F<E> {
        U32F::saturating_from_u128f(self)
    }
    ...
    pub const fn overflowing_into_u32f(self) -> (U32F<E>, bool) {
        U32F::overflowing_from_u128f(self)
    }
    ...
    pub const fn saturating_into_u64f(self) -> U64F<E> {
        U64F::saturating_from_u128f(self)
    }
    ...
    pub const fn overflowing_into_u64f(self) -> (U64F<E>, bool) {
        U64F::overflowing_from_u128f(self)
    }
    ...
    #[must_use]
    #[track_caller]
    pub const fn rescale<const E2: i32>(self) -> U128F<E2> {
    ...
    #[must_use]
    #[track_caller]
    pub const fn strict_rescale<const E2: i32>(self) -> U128F<E2> {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn wrapping_rescale<const E2: i32>(self) -> U128F<E2> {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn saturating_rescale<const E2: i32>(self) -> U128F<E2> {
        let mut x = self.significand;
    ...
    #[must_use]
    pub const fn overflowing_rescale<const E2: i32>(self) -> (U128F<E2>, bool) {
        let mut x = self.significand;
        ...
        (U128F { significand: x }, overflowed)
    }
    ...
    #[must_use]
    pub const fn checked_rescale<const E2: i32>(self) -> Option<U128F<E2>> {
        let mut x = self.significand;
    ...
    pub const fn add_signed(self, rhs: I128F<E>) -> Self {
        let x = self.significand.wrapping_add(rhs.significand as u128);
    ...
    pub const fn wrapping_add_signed(self, rhs: I128F<E>) -> Self {
        Self {
            significand: self.significand.wrapping_add(rhs.significand as u128),
        }
    }
    ...
    pub const fn sub_signed(self, rhs: I128F<E>) -> Self {
        let x = self.significand.wrapping_sub(rhs.significand as u128);
    ...
    pub const fn wrapping_sub_signed(self, rhs: I128F<E>) -> Self {
        Self {
            significand: self.significand.wrapping_sub(rhs.significand as u128),
        }
    }
...
impl<const E: i32> ops::Add<I128F<E>> for U128F<E> {
    type Output = Self;

    #[track_caller]
    fn add(self, rhs: I128F<E>) -> Self::Output {
...
impl<const E: i32> ops::Sub<I128F<E>> for U128F<E> {
    type Output = Self;

    #[track_caller]
    fn sub(self, rhs: I128F<E>) -> Self::Output {
        Self::sub_signed(self, rhs)
    }
}

impl<const E: i32> ops::AddAssign for U128F<E> {
    #[track_caller]
...
impl<const E: i32> ops::AddAssign<I128F<E>> for U128F<E> {
    #[track_caller]
    fn add_assign(&mut self, rhs: I128F<E>) {
        *self = Self::add_signed(*self, rhs)
    }
}

impl<const E: i32> ops::SubAssign for U128F<E> {
    #[track_caller]
...
impl<const E: i32> ops::SubAssign<I128F<E>> for U128F<E> {
    #[track_caller]
    fn sub_assign(&mut self, rhs: I128F<E>) {
